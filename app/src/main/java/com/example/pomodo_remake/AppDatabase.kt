            ...
            override fun onCreate(db: SupportSQLiteDatabase) {
                ...
                CoroutineScope(Dispatchers.IO).launch {
                    database.timerRecordsDao().apply {
                        ...
                        insertOrUpdateRecord(TimerRecords("2024-11-18", 3 * 60 * 60 * 1000L)) // 3시간 (2시간 1초 ~ 4시간 색상: #A2D6F8)
                        insertOrUpdateRecord(TimerRecords("2024-11-20", 5 * 60 * 60 * 1000L)) // 5시간 (4시간 1초 ~ 6시간 색상: #8DCBF7)
                        insertOrUpdateRecord(TimerRecords("2024-11-22", 7 * 60 * 60 * 1000L)) // 7시간 (6시간 1초 ~ 8시간 색상: #79C0F7)
                        insertOrUpdateRecord(TimerRecords("2024-11-25", 10 * 60 * 60 * 1000L)) // 10시간 (8시간 1초 ~ 20시간 색상: #64B5F6)
